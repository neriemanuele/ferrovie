...
const LINES = [
  ...
  { label: "Bologna-Pistoia (Porrettana)", article: "Ferrovia Bologna-Pistoia", manager: RFI_MANAGER, aliases: ["Bologna–Pistoia", "Bologna–Pistoia (Porrettana)"] },
  { label: "Bologna-Rimini", article: "Ferrovia Bologna-Ancona", manager: RFI_MANAGER, aliases: ["Bologna–Rimini"], segment: ["0+000 Bologna Centrale", "111+042 Rimini"] },
  { label: "Rimini-Ancona", article: "Ferrovia Bologna-Ancona", manager: RFI_MANAGER, segment: ["111+042 Rimini", "203+996 Ancona"] },
  { label: "Castel Bolognese-Ravenna", article: "Ferrovia Castel Bolognese-Ravenna", manager: RFI_MANAGER, aliases: ["Castel Bolognese–Ravenna"] },
  { label: "Faenza-Ravenna", article: "Ferrovia Faenza-Ravenna", manager: RFI_MANAGER, aliases: ["Faenza–Ravenna"] },
  { label: "Ferrara-Rimini", article: "Ferrovia Ferrara-Rimini", manager: RFI_MANAGER, aliases: ["Ferrara–Rimini"] },
  { label: "Occhiobello-Bologna", article: "Ferrovia Padova-Bologna", manager: RFI_MANAGER, aliases: ["Occhiobello–Bologna"], segment: ["54+000 53+654 Occhiobello", "0+000 Bologna Centrale"] },
  { label: "Bologna-Prato (Direttissima)", article: "Ferrovia Bologna-Firenze (direttissima)", manager: RFI_MANAGER, aliases: ["Bologna–Prato", "Bologna–Prato (Direttissima)"], segment: ["96+908 Bologna Centrale", "16+386 Prato Centrale"] },
  { label: "Poggio Rusco-Bologna", article: "Ferrovia Verona-Bologna", manager: RFI_MANAGER, aliases: ["Poggio Rusco–Bologna"], segment: ["59+430 Poggio Rusco", "0+000 Bologna Centrale"] },
  ...
  { label: "Suzzara-Modena", article: "Ferrovia Verona-Mantova-Modena", manager: RFI_MANAGER, aliases: ["Suzzara–Modena"], segment: ["42+153 Suzzara", "0+000 Modena"] },
